...
function addAdjustmentLayer(compItem: CompItem, useShapeLayer: Boolean = true, layerName: string = "addAdjustment", layerColor: ThreeDColorValue = [1, 1, 1]): AVLayer {
    ...
    if (useShapeLayer) {
        ...
        (getProperty(VectorsGroup, ['ADBE Vector Shape - Rect', "ADBE Vector Rect Size"]) as Property).expression = "[compItem.width,compItem.height]";
